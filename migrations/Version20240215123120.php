 ...
 */
final class Version20240215123120 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        , brand VARCHAR(255) DEFAULT NULL, is_available BOOLEAN DEFAULT NULL, status VARCHAR(255) NOT NULL, is_best_seller BOOLEAN DEFAULT NULL, is_new_arrival BOOLEAN DEFAULT NULL, is_featured BOOLEAN DEFAULT NULL, is_special_offer BOOLEAN DEFAULT NULL)');
